...
//
        ...
        db.add(new TreasureLocation("F-10",question,"", "F-10", 13));
        ...
        db.add(new TreasureLocation("FLEX",question,"An anomaly that was intentional, shall guide you the way", "G-9", 100));
    }
